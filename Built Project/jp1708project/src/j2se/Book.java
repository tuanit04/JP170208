...
public class Book {
    ...
    public static void main(String[] args){
        ...
        Address addr1=new Address("Ha Noi","Bac Tu Liem", "Pho Nhon");
        Person p5 = new Person("Tuan","Nguyen",(byte)21 , addr1);

        Book b1 = new Book();
        Book b2 = new Book((short) 1,"LTHDT","Lap trinh",p5,(short)23,"Quang Huy","Fptbook.com");
